...
(function () {
  ...
  const RAW_MEMBERS = [
    ...
    { id:11, name:'王梓涵', gender:'男', img:15, age:32, city:'北京', district:'', height:178, zodiac:'天秤座', job:'企业主管', income:'30万以上', marriage:'未婚', education:'本科', housing:'有(无贷款)', car:'有', interests:'健身、阅读、旅游', intro:'企业管理者，稳重有担当。希望遇到一个温柔懂事、三观契合的伴侣。', uid:'00011', updated:'2026-07-19', photo:'assets/images/member-00011.jpg' },
    ...
    { id:12, name:'顾辰',   gender:'男', img:12, age:30, city:'北京', district:'海淀区', height:178, zodiac:'天秤座', job:'软件工程师', income:'30万以上', marriage:'未婚', education:'本科', housing:'有(无贷款)', car:'有', interests:'编程、登山、摄影', intro:'程序员但不宅，周末爱登山拍照。想找个能一起看世界的人。', uid:'00012', updated:'2026-07-19', photo:'assets/images/member-00012.jpg' },
    { id:13, name:'张沐阳', gender:'男', img:13, age:33, city:'深圳', district:'福田区', height:180, zodiac:'金牛座', job:'投资人', income:'30万以上', marriage:'未婚', education:'硕士', housing:'有(无贷款)', car:'有', interests:'金融、滑雪、红酒', intro:'投资人，看人很准。希望遇到一个真诚、有自己热爱的人。', uid:'00013', updated:'2026-07-19', photo:'assets/images/member-00013.jpg' },
    { id:14, name:'刘宇航', gender:'男', img:14, age:31, city:'上海', district:'徐汇区', height:175, zodiac:'双子座', job:'医生', income:'30万以上', marriage:'未婚', education:'博士', housing:'有(无贷款)', car:'有', interests:'医学研究、跑步、阅读', intro:'外科医生，忙但靠谱。期待一个理解我的节奏、温柔以待的人。', uid:'00014', updated:'2026-07-19', photo:'assets/images/member-00014.jpg' },
